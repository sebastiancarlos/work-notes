...
install: installdirs
	...
	@$(LN_S) $(srcdir)/work-notes $(DESTDIR)$(bindir)/work-notes
	@echo -e '   'Installing $(green)work-notes$(reset) in $(green)$(DESTDIR)$(bindir)/$(reset)$(bold)work-notes$(reset)
...
uninstall:
	...
	@rm -f $(DESTDIR)$(bindir)/work-notes
	@echo -e '   'Deleting file $(green)work-notes$(reset) in $(green)$(DESTDIR)$(bindir)/$(reset)$(bold)work-notes$(reset)
